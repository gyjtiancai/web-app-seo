...
class HttpClient {
  ...
  public get(url: string, params?: any, config?: InternalAxiosRequestConfig): Promise<Response> {
    return this.instance.get(url, { ...config, params })
  }

  public post(url: string, data?: any, config?: InternalAxiosRequestConfig): Promise<Response> {
    return this.instance.post(url, data, config)
  }

  public delete(url: string, config?: InternalAxiosRequestConfig): Promise<Response> {
    return this.instance.delete(url, config)
  }

  public put(url: string, data?: any, config?: InternalAxiosRequestConfig): Promise<Response> {
    return this.instance.put(url, data, config)
  }

  public patch(url: string, data?: any, config?: InternalAxiosRequestConfig): Promise<Response> {
    return this.instance.patch(url, data, config)
  }

  public request(config: InternalAxiosRequestConfig): Promise<Response> {
